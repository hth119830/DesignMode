...
public class CalendarTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            Date d = df.parse("2020-03-06");
            ca.setTime(d);//设置当前时间

            CalendarTest ct = new CalendarTest();
            ct.initHolidayList("2020-10-01");//初始节假日
            ct.initHolidayList("2016-09-16");//初始节假日
            ct.initHolidayList("2020-03-06");//初始节假日

            ct.initWeekendList("2016-09-18");//初始工作日
//            ct.initWeekendList("2020-03-07");//初始工作日
